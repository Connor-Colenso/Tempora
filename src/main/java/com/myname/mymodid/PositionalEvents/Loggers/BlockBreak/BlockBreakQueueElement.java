...
public class BlockBreakQueueElement extends GenericQueueElement {
    ...
    public String localiseText() {
        ...
        return StatCollector.translateToLocalFormatted("message.block_break", playerNameWhoBrokeBlock, localizedName, Math.round(x), Math.round(y), Math.round(z), formattedTime);
    }
}
